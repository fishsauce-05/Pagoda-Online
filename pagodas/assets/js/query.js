...
const fortuneQueries = [
  ...
  },
  {
    ...
    answers: [
      ...
      "Cải thiện sự hiểu biết về cuộc sống, đọc sách, học hỏi những điều mới. Trí tuệ là hấp lực đích thực.",
  ...
  },
  {
    ...
    answers: [
      ...
      "Bạn thu hút nhiều hơn bạn nghĩ. Hãy để người khác nhìn thấy điểm tốt đó.",
  ...
  //Chùa Thánh Chúa
  {
    question: "Kỳ thi sắp tới có thuận lợi không?",
    answers: [
      "Kỳ thi tới khá thuận lợi nếu bạn giữ bình tĩnh và ôn tập đúng trọng tâm.",
      "Kết quả tốt đang chờ bạn, miễn là không để sự lo lắng làm phân tâm.",
      "Bạn có vận may trong học tập, nhưng thành công vẫn đến từ sự chuẩn bị kỹ càng.",
      "Thi cử hanh thông, chỉ cần ngủ đủ giấc và giữ tinh thần ổn định.",
      "Đề thi có thể đúng vào phần bạn đã học. Hãy tự tin thể hiện hết khả năng.",
      "Nếu chăm chỉ trong những ngày cuối, bạn sẽ cải thiện rõ rệt kết quả.",
      "Thuận lợi có sẵn, việc còn lại là tin vào bản thân.",
      "Đây là kỳ thi mang lại bước tiến tốt cho bạn nếu không bỏ cuộc giữa chừng."
    ]
  },
  {
    question: "Nên tập trung vào môn nào lúc này?",
    answers: [
      "Hãy ưu tiên môn bạn còn yếu nhất, vì đó là nơi tăng điểm nhanh nhất.",
      "Tập trung vào môn quan trọng trong tổ hợp xét tuyển của bạn.",
      "Môn cần luyện lúc này là môn bạn đang né tránh.",
      "Ưu tiên môn nền tảng trước, rồi mở rộng sang môn phụ.",
      "Môn nào khiến bạn mất tự tin nhất thì nên dành thời gian cho nó.",
      "Hãy cân bằng, nhưng dành nhiều sức hơn cho môn tạo đột phá điểm số.",
      "Môn cần học nhất là môn xuất hiện nhiều trong kỳ thi sắp tới.",
      "Đừng chọn theo cảm xúc, hãy chọn theo mục tiêu dài hạn."
    ]
  },
  {
    question: "Bao giờ việc học có khởi sắc?",
    answers: [
      "Ngay khi bạn thay đổi cách học, vận học tập sẽ chuyển biến tích cực.",
      "Trong vài tháng tới sẽ có bước tiến rõ rệt nếu bạn kiên trì.",
      "Khởi sắc đến từ những thói quen nhỏ lặp lại mỗi ngày.",
      "Thời gian tốt đang tới gần, đừng nản ở hiện tại.",
      "Bạn sắp thấy thành quả từ công sức âm thầm trước đó.",
      "Khi tinh thần ổn định hơn, việc học sẽ đi lên rất nhanh.",
      "Sự tiến bộ đến chậm nhưng chắc, hãy tiếp tục cố gắng.",
      "Khoảng thời gian tới là cơ hội tốt để bứt phá."
    ]
  }
];
